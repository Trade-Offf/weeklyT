# 17 Equations that Changed the World - Rewritten in JavaScript (用 JavaScript 重写 17 个改变世界的方程式)

[点击访问原文](https://runjs.app/blog/equations-that-changed-the-world-rewritten-in-javascript)
...
[Ian Stewart](https://zh.wikipedia.org/wiki/%E8%89%BE%E6%81%A9%C2%B7%E5%8F%B2%E9%83%BD%E8%8F%AF) 的《改变世界的 17 个方程式》一书概述了塑造现代世界的 17 个基本方程式。本文将探索如何用 JavaScript 编写实现这些数学公式，通过实践的形式，更容易理解这些复杂的概念。
